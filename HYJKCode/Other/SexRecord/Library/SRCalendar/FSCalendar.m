...
- (void)initialize
{
    ...
    collectionViewFlowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;//水平滑动
//    collectionViewFlowLayout.scrollDirection = UICollectionViewScrollDirectionVertical;//竖直滑动
    ...
    _subtitleColors[@(FSCalendarCellStateDisabled)]    = [UIColor clearColor];
    _subtitleColors[@(FSCalendarCellStatePlaceholder)] = [UIColor clearColor];
...
{
    return [_maximumDate fs_monthsFrom:_minimumDate] + 1;//该年月数+1
}

- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section
{
    return 42;//六行 七列 42个单元格
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleColors        = self.titleColors;//新历颜色
    cell.subtitleColors     = self.subtitleColors;//农历颜色
