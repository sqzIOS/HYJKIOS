...
-(void)setIsFenLei:(BOOL)fenlei
{
    self.header.isFenLei=fenlei;
    self.footer.isFenLei=fenlei;
}

-(BOOL)isFenLei
{
    return self.footer ?  self.footer.isFenLei : self.header.isFenLei;//查询的话 查头 查尾 都可以 哪个存在查哪个;
}
