...
/*********
        ...
        **************/
        ...
        self.headImageView.image=[UIImage imageNamed:@"doctor.png"];
        self.sexImageView.image=[UIImage imageNamed:@""];
        self.sexImageView.backgroundColor=[UIColor redColor];
        self.ageLabel.text=pText.ageStr;
        self.contentLabel.text=pText.contentStr;
        self.timeLabel.text=pText.timeStr;
        self.answerlabel.text=pText.answerStr;
        self.completelabel.text=pText.completeStr;
    }
    return self;
}
@end
